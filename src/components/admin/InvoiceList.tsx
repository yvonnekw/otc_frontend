...
const InvoiceList: React.FC = () => {
    ...
    // Define the columns with specific fields and an Actions column
    const columns = useMemo<Column<InvoiceData>[]>(() => [
        { Header: 'Invoice ID', accessor: 'invoiceId' }, // Ensure keys are lowercase to match the data
        { Header: 'Amount', accessor: 'amount' },
        { Header: 'Date', accessor: 'date' },
        { Header: 'Status', accessor: 'status' },
        {
    ...
    const handleActionClick = (invoice: InvoiceData) => {
        setSelectedInvoice(invoice);
        setDialogOpen(true);
    };
...
const InvoiceList: React.FC = () => {
    ...
    // Define the columns with specific fields and an Actions column
    const columns = useMemo<Column<InvoiceData>[]>(() => [
        { Header: 'Invoice ID', accessor: 'invoiceId' }, // Note: Ensure keys are lowercase to match the data
        { Header: 'Amount', accessor: 'amount' },
        { Header: 'Date', accessor: 'date' },
        { Header: 'Status', accessor: 'status' },
        {
    ...
    const handleActionClick = (invoice: InvoiceData) => {
        // Implement your update logic here
        console.log('Update invoice with ID:', invoice.invoiceId);
